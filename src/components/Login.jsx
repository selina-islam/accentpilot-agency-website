...
const Login = () => {
 ...
 const onSubmit = (data) => console.log(data)
  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-screen mx-w-md '>
      <div className='bg-gray-300 p-4 text-black rounded shadow shadow-blue-400'>
        ...
        <h2 className='text-2xl text-center text-gray-800 font-semibold mb-4'>Please Login</h2>
  ...
  message: 'password must be at least 6 characters'
       ...
       <button className='bg-blue-600 mt-2 w-full p-1 rounded text-white hover:bg-blue-700 transition transform duration-200 text-sm'>Login</button>
      </form>
      ...
      <p className='text-xs text-center pt-2'>Don't have an account? Please <Link to='/register' className='text-blue-800 underline cursor-pointer'>Sign Up</Link></p>
      </div>
    </div>
  )
}
